...
[DEVELOPER (HTML)] should be replaced with the developer who made the game, written per webpage naming standards.
[DEVELOPER] should be replaced with the developer who made the game.
[PUBLISHER (HTML)] should be replaced with the company who pubished the game, written per webpage naming standards.
[PUBLISHER] should be replaced with the company who pubished the game.
[DUMPER (HTML)] should be replaced with the person(s) who dumped the songs in the set, written per webpage naming standards.
[DUMPER] should be replaced with the person(s) who dumped the songs in the set.
[TAGGER (HTML)] should be replaced with the person(s) who tagged the songs in the set, written per webpage naming standards.
[TAGGER] should be replaced with the person(s) who tagged the songs in the set.
...
<head>
  <meta charset="utf-8">
  <title>PCMusic - Saltando con Doki (Flash)</title>
  <meta name="generator" content="Google Web Designer 11.0.2.0415">
  <style type="text/css" id="gwd-text-style">
  <link rel="shortcut icon" href="https://lucianothewindowsfan.github.io/pcmusic/favicon.ico" />
    p {
      margin: 0px;
    }
    h1 {
